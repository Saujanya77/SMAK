      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/privacy-policy" className="text-gray-300 hover:text-blue-400 transition-colors">Privacy Policy</Link></li>
              ...
              <li><Link to="/contact" className="text-gray-300 hover:text-blue-400 transition-colors">Help Center</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">contact@smak.in</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-sm text-gray-300">
          <p>&copy; 2025 SMAK - Society for Medical Academia and Knowledge. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
