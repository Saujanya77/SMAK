...
const ClinicalCases = () => {
  ...
  const clinicalCases = [
    {
      id: 1,
      title: "Acute Myocardial Infarction in 45-Year-Old Male",
      description: "A comprehensive case study of STEMI presentation, diagnosis, and management",
      category: "Cardiology",
      difficulty: "Advanced",
      duration: "45 min",
      views: 234,
    ...
    },
    {
      ...
      description: "Step-by-step approach to DKA diagnosis and treatment protocols",
    ...
    {
      id: 3,
      title: "Pediatric Respiratory Distress Syndrome",
      description: "Clinical presentation and management of RDS in newborns",
      category: "Pediatrics",
      difficulty: "Advanced",
      duration: "35 min",
      views: 156,
            ...
            <Card className="mb-8 border-blue-200 bg-blue-50 dark:bg-blue-900/10">
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea placeholder="Detailed case description..." rows={4} />
                </div>
                ...
                <div className="flex space-x-4">
                  <Button className="bg-blue-600 hover:bg-blue-700">Save Case</Button>
              ...
              <Card key={caseItem.id} className="group hover:shadow-lg transition-all border-gray-200 hover:border-blue-300">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center justify-between text-sm text-gray-500">
                    ...
                    <span>{caseItem.publishedDate}</span>
                  </div>
